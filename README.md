- Desenvolvedor web com Angular, Node e NestJS.
- Já estudei linguagens como C#(.net Core) e Java(Spring Boot), mas não sou especialista em nenhuma delas. Porém tenho bons conhecimentos dos conceitos, estruturas de dados e paradigmas de programação.
